...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('Submitting login form with:', { username: formData.username, password: '***' });
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-slate-800 dark:text-white mb-2">Admin Login</h1>
            <p className="text-slate-600 dark:text-white/70">Enter your credentials to manage blogs</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Username Field */}
            <div>
              <label htmlFor="username" className="block text-slate-800 dark:text-white font-medium mb-2">
                Username
              </label>
            ...
            {/* Password Field */}
            <div>
              <label htmlFor="password" className="block text-slate-800 dark:text-white font-medium mb-2">
                Password
              </label>
              <div className="relative">
          ...
          >
            <p className="text-slate-500 dark:text-white/60 text-sm text-center mb-2">Demo Credentials:</p>
            <div className="text-center space-y-1">
              <p className="text-slate-700 dark:text-white/80 text-sm">Username: <span className="font-mono bg-slate-300 dark:bg-slate-600/50 px-2 py-1 rounded">admin</span></p>
              <p className="text-slate-700 dark:text-white/80 text-sm">Password: <span className="font-mono bg-slate-300 dark:bg-slate-600/50 px-2 py-1 rounded">admin123</span></p>
            </div>
