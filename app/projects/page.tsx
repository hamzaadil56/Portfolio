...
import { ArrowLeft, ExternalLink, Github, Calendar, Users, Code, Zap, Database, Globe } from 'lucide-react';
  ...
  const projects = [
    {
      ...
      description: "Led the frontend development of a comprehensive customer portal for Pakistan's pioneering digital asset management platform, focusing on performance optimization and scalable architecture.",
      image: "https://images.pexels.com/photos/6802049/pexels-photo-6802049.jpeg",
      technologies: ["React.js", "Redux", "TypeScript", "Tailwind CSS", "REST APIs", "Jest"],
      achievements: [
    ...
    },
    {
      ...
      description: "Architected and developed an innovative AI-powered platform that automates software quality assurance workflows using OpenAI's Large Language Models and modern microservices architecture.",
      image: "https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg",
      technologies: ["FastAPI", "Python", "OpenAI", "LangChain", ".NET Core", "Docker", "PostgreSQL"],
      achievements: [
    ...
    },
    {
      ...
      description: "Designed and implemented a comprehensive Over-The-Top (OTT) streaming platform with advanced content management capabilities and high-performance cloud infrastructure.",
      image: "https://images.pexels.com/photos/4348401/pexels-photo-4348401.jpeg",
      technologies: ["AWS Amplify", ".NET Core", "Lambda", "S3", "OneDrive API", "React.js"],
      achievements: [
    ...
    },
    {
      ...
      description: "Built a comprehensive e-learning platform with advanced database optimization and integrated payment systems for seamless course purchasing experience.",
    ...
    },
    {
      ...
      description: "Developed a large-scale government platform for educational initiatives, successfully handling massive user registration and course management for the Governor Sindh Initiative.",
      image: "https://images.pexels.com/photos/5428836/pexels-photo-5428836.jpeg",
      technologies: ["Next.js 13", "PostgreSQL", "Node.js", "Redis", "Docker", "Nginx"],
      achievements: [
    ...
    },
    {
      ...
      description: "Developed an innovative Generative AI-powered personalized mentoring platform that secured a top 10 position at the BWAI hackathon organized by GDGKolachi.",
      image: "https://images.pexels.com/photos/8439093/pexels-photo-8439093.jpeg",
      technologies: ["OpenAI", "Python", "FastAPI", "React.js", "TensorFlow", "Vector DB"],
      achievements: [
              ...
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="relative overflow-hidden lg:order-1 h-64 lg:h-auto">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className={`px-3 py-1 bg-gradient-to-r ${project.colors.primary} text-white rounded-full text-sm font-medium`}>
                      {project.category}
                    </span>
                  </div>
                  <div className="absolute bottom-4 right-4 flex gap-2">
                    <div className={`w-10 h-10 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center ${project.colors.accent} hover:bg-white/20 transition-colors cursor-pointer`}>
                ...
                <div className="p-6 md:p-8 lg:p-12 lg:order-2">
                  <div className="flex flex-wrap items-center gap-3 md:gap-4 mb-4">
                    ...
                    <div className={`px-3 py-1 bg-gradient-to-r ${project.colors.primary} bg-opacity-20 ${project.colors.accent} rounded-full text-sm`}>
                      {project.status}
                    </div>
                  </div>

                  <h3 className="text-2xl md:text-3xl font-bold text-slate-800 dark:text-white mb-2 heading-fix">{project.title}</h3>
                  <h4 className={`text-base md:text-lg font-medium ${project.colors.accent} mb-4`}>{project.subtitle}</h4>
                  <p className="text-slate-600 dark:text-white/70 mb-6 leading-relaxed text-sm md:text-base">{project.description}</p>
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="space-y-2">
                      {project.achievements.map((achievement, achIndex) => (
                        <li key={achIndex} className="flex items-start gap-3 text-slate-600 dark:text-white/70 text-xs md:text-sm">
                          <div className={`w-2 h-2 ${project.colors.primary} bg-gradient-to-r rounded-full mt-2 flex-shrink-0`}></div>
                          {achievement}
                        </li>
                      ))}
                    </ul>
