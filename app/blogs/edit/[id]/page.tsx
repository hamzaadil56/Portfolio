    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 flex items-center justify-center">
        <div className="text-center">
          <div className="text-red-400 text-xl mb-4">Blog not found</div>
          <Link 
            href="/blogs"
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="gradient" className="block text-white font-medium mb-2">
                  Gradient
                </label>
                <select
                  id="gradient"
              ...
              <div>
                <label htmlFor="platformColor" className="block text-white font-medium mb-2">
                  Platform Color
                </label>
                <select
                  id="platformColor"
