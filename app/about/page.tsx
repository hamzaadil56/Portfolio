...
export default function About() {
	const values = [
		...
		},
		{
			...
			title: "Collaboration",
			description:
				"Believing that the best solutions come from diverse minds working together.",
		},
		{
			icon: Lightbulb,
			title: "Innovation",
		...
		},
		{
			...
			description:
				"Bringing enthusiasm and dedication to every project and challenge.",
		},
	];
	...
	const journey = [
		{
			...
			description:
				"Began my bachelor's degree at NED University, diving into the world of chemical processes and engineering principles.",
		},
		{
			year: "2020",
			title: "COVID & The Programming Discovery",
			description:
				"When the pandemic hit during my 2nd year, I discovered programming. What started as curiosity quickly became a passion that would change my entire career trajectory.",
		},
		{
			year: "2021-2023",
			title: "Dual Journey",
			description:
				"Balanced my chemical engineering studies while diving deep into programming, learning web development, and building my first projects.",
		},
		{
			year: "2023",
			title: "Professional Transition",
			description:
				"Graduated with my engineering degree and fully transitioned into software development, starting my career at Panacloud.",
		},
		{
			year: "2024-Present",
			title: "Full Stack Engineer",
			description:
				"Now working with cutting-edge technologies, building AI-powered solutions, and contributing to innovative projects at leading companies.",
		},
	];
			...
			<div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6 py-8 md:py-12">
				...
				>
					...
					<p className="text-lg md:text-xl text-slate-600 dark:text-white/70 max-w-3xl mx-auto">
						From Chemical Engineering to Full Stack Development - A
						journey of passion, discovery, and continuous learning.
					</p>
				</motion.div>
				...
				>
					...
					>
						<div className="flex items-center gap-3 mb-6 md:mb-8">
							...
							<h2 className="text-2xl md:text-3xl font-bold text-slate-800 dark:text-white heading-fix">
								My Journey
							</h2>
						</div>
						...
						<div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
							<p className="text-slate-700 dark:text-white/80 text-base md:text-lg leading-relaxed mb-4 md:mb-6">
								My story begins in 2019 when I started my
								bachelor's degree in Chemical Engineering at NED
								University of Engineering and Technology. Like
								many engineering students, I was fascinated by
								the complexity of chemical processes and the
								science behind industrial systems.
							</p>

							<p className="text-slate-700 dark:text-white/80 text-base md:text-lg leading-relaxed mb-4 md:mb-6">
								But then came 2020, and with it, the global
								pandemic that changed everything. During my
								second year of engineering, as the world went
								into lockdown and classes moved online, I found
								myself with unexpected free time and a curious
								mind. That's when I stumbled upon programming.
							</p>

							<p className="text-slate-700 dark:text-white/80 text-base md:text-lg leading-relaxed mb-4 md:mb-6">
								What started as a casual exploration quickly
								became an obsession. I was captivated by the
								power of code - the ability to create something
								from nothing, to solve problems with logic and
								creativity, and to build applications that could
								impact people's lives. The more I learned, the
								more I realized that this was my true calling.
							</p>

							<p className="text-slate-700 dark:text-white/80 text-base md:text-lg leading-relaxed mb-4 md:mb-6">
								The next few years were a balancing act. By day,
								I was studying chemical engineering - learning
								about thermodynamics, process control, and
								reactor design. By night, I was diving deep into
								JavaScript, React, and web development. I was
								living in two worlds, but I knew which one felt
								like home.
							</p>

							<p className="text-slate-700 dark:text-white/80 text-base md:text-lg leading-relaxed">
								After graduating with my engineering degree in
								2023, I made the leap into software development
								full-time. Since then, I've been fortunate to
								work on incredible projects, from AI-powered
								platforms to large-scale web applications,
								always pushing myself to learn and grow. Today,
								I'm a Full Stack Engineer who brings the
								analytical thinking of an engineer and the
								creative problem-solving of a developer to every
								project I touch.
							</p>
						</div>
					</motion.div>
							...
							>
								...
								<div className="flex-1 pb-6 md:pb-8">
									<div className="flex flex-col sm:flex-row sm:items-center gap-2 md:gap-3 mb-2">
										<span className="text-blue-500 dark:text-blue-400 font-bold text-base md:text-lg">
											{item.year}
										</span>
										<h3 className="text-lg md:text-xl font-semibold text-slate-800 dark:text-white heading-fix">
											{item.title}
										</h3>
									</div>
									<p className="text-slate-600 dark:text-white/70 text-sm md:text-base">
										{item.description}
									</p>
								</div>
							</motion.div>
				...
				>
					...
					<motion.p
						...
						viewport={optimizedViewport}
					>
						Whether you want to discuss technology, collaborate on a
