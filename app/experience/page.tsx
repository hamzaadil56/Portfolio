	...
	const experiences = [
		{
			...
			companyInfo:
				"YC W22 - Pakistan's first digital Asset Management Company",
		},
		{
			title: "Full Stack Engineer",
			company: "mParsec",
			...
			type: "Full-time",
			description:
				"Developed full-stack applications and AI-powered solutions for multiple clients.",
			achievements: [
		...
		},
		{
			...
			type: "Internship",
			description:
				"Contributed to high-impact government projects and gained hands-on experience in full-stack development.",
			achievements: [
	...
	const achievements = [
		{
			...
			description:
				"Pitched 'EQ Mentor', a Generative AI-powered personalized mentor, securing a top 10 spot and earning the Mentor title.",
			year: "2024",
		},
		{
			...
			description:
				"Received international appreciation from lablab.ai Grants Manager and Technical Mentor for ResearchMind: AI-Powered Project Mentor for Research Mastery.",
			year: "2024",
		},
		{
			...
			description:
				"Successfully delivered freelance projects with 99.9% client satisfaction across multiple domains.",
			year: "2023-2024",
		},
	];
			...
			<div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6 py-8 md:py-12">
				...
				>
					...
					<p className="text-lg md:text-xl text-slate-600 dark:text-white/70 max-w-3xl mx-auto">
						A journey through my professional growth in software
						engineering, from internships to leading full-stack
						development at innovative companies.
					</p>
				</motion.div>
							...
							>
								<div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6">
									<div className="flex-1">
										<h3 className="text-xl md:text-2xl font-bold text-slate-800 dark:text-white mb-2 heading-fix">
											{exp.title}
										</h3>
										<div className="flex flex-wrap items-center gap-3 md:gap-4 mb-4">
											<span className="text-blue-500 dark:text-blue-400 text-base md:text-lg font-medium">
												{exp.company}
											</span>
										...
										<p className="text-slate-600 dark:text-white/70 mb-4 text-sm md:text-base">
											{exp.companyInfo}
										</p>
									</div>
								...
								<p className="text-slate-700 dark:text-white/80 mb-6 text-sm md:text-base">
									{exp.description}
								</p>

								<div className="mb-6">
									<h4 className="text-slate-800 dark:text-white font-semibold mb-3 text-sm md:text-base heading-fix">
										Key Achievements:
									</h4>
									<ul className="space-y-2">
										{exp.achievements.map(
											(achievement, achIndex) => (
												<li
													key={achIndex}
													className="flex items-start gap-3 text-slate-600 dark:text-white/70 text-sm"
												>
					...
					>
						<div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6">
							<div className="flex-1">
								...
								<div className="text-purple-500 dark:text-purple-400 text-base md:text-lg font-medium mb-4">
						...
						{achievements.map((achievement, index) => (
							...
							>
								<div className="flex items-start justify-between mb-3">
									<h3 className="text-lg md:text-xl font-bold text-slate-800 dark:text-white heading-fix">
										{achievement.title}
									</h3>
									<span className="text-yellow-500 dark:text-yellow-400 font-medium text-sm">
										{achievement.year}
									</span>
								</div>
								<div className="text-yellow-500 dark:text-yellow-400 font-medium mb-2 text-sm md:text-base">
